...
![VirtIO CD contents with virtio-win-guest-tools.exe visible](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/virtio-file-explorer.png)
...
![Windows Update downloading and installing updates](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/windows-update-running.png)
...
![Windows Update GUI stuck](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/windows-update-stuck.png)
...
![PowerShell ready for PSWindowsUpdate commands](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/powershell-wuauclt.png)
...
![Installing the PSWindowsUpdate module](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/pswu-install.png)
...
![PSWindowsUpdate running through the available KB updates](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/pswu-running.png)
...
![Windows applying updates during reboot](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/windows-update-30pct.png)
...
![Windows Update says you're up to date after the first round](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/windows-uptodate-1.png)
*The first pass may already report the machine as up to date.*

![Windows Update confirmed fully up to date after a second check](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/windows-uptodate-final.png)
...
![Example of a Windows Update error that can be ignored in a lab VM](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/windows-update-error.png)
...
![RDP connectivity verification from the Proxmox host](/blog/2026-proxmox-windows-server-2022-template-voorbereiding/rdp-verification.png)
