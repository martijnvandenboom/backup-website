...
<div class="hugo-animation-container">
    <div class="left-div">4. De roterende cirkel:</br>
        Deze animatie toont onze expertise met Hugo, de snelle static site generator die we gebruiken om moderne websites te bouwen. In het midden staat het officiële Hugo-logo. Rondom draait de tekst samen met het icoon van gohugo.io: <em>Hugo · static site generator · Written in Golang</em> — een knipoog naar de Go-taal waarin Hugo is geschreven, en naar de continue beweging van het web.
    </div>
    <div class="right-div">
