(function() {
    ...
    widget.innerHTML = `
        <div class="accessibility-btn" title="Accessibility Menu">
        ...
        <div class="accessibility-panel">
            ...
            <div class="accessibility-content">
                <div class="acc-option" data-action="tts"><span>🔊 Voorlezen</span></div>
                <div class="acc-option" data-action="grayscale"><span>🔘 Grijstinten</span></div>
                <div class="acc-option" data-action="high-contrast"><span>🌓 Hoog contrast</span></div>
                <div class="acc-option" data-action="negative"><span>🔄 Negatief</span></div>
                <div class="acc-option" data-action="bright"><span>☀️ Helder</span></div>
                <div class="acc-option" data-action="sepia"><span>📜 Sepia</span></div>
                <div class="acc-option" data-action="low-sat"><span>🔅 Lage verzadiging</span></div>
                <div class="acc-option" data-action="high-sat"><span>🔆 Hoge verzadiging</span></div>
                <div class="acc-option" data-action="night"><span>🌙 Nachtstand</span></div>
                <div class="acc-option" data-action="text-inc"><span>➕ Tekst groter</span></div>
                <div class="acc-option" data-action="text-dec"><span>➖ Tekst kleiner</span></div>
                <div class="acc-option" data-action="dyslexic"><span>📖 Dyslexie font</span></div>
                <div class="acc-option" data-action="big-cursor"><span>🖱️ Grote cursor</span></div>
                <div class="acc-option" data-action="links"><span>🔗 Links markeren</span></div>
                <div class="acc-option" data-action="headers"><span>📑 Titels markeren</span></div>
                <div class="acc-option" data-action="spacing"><span>↔️ Tekstafstand</span></div>
                <div class="acc-option" data-action="line-height"><span>↕️ Regelafstand</span></div>
                <div class="acc-option" data-action="guide"><span>📏 Leesliniaal</span></div>
                <div class="acc-option" data-action="mask"><span>🎭 Leesmasker</span></div>
                <div class="acc-option" data-action="stop-anim"><span>🚫 Geen animatie</span></div>
                <div class="acc-option" data-action="readable"><span>🖋️ Leesbaar font</span></div>
                <div class="acc-option" data-action="align-left"><span>⬅️ Links uitlijnen</span></div>
                <div class="acc-option" data-action="align-center"><span>↔️ Centreren</span></div>
                <div class="acc-option" data-action="align-right"><span>➡️ Rechts uitlijnen</span></div>
                <div class="acc-option" data-action="align-justify"><span>↔️ Uitvullen</span></div>
                <div class="acc-option" data-action="reset"><span>🔄 Reset alles</span></div>
            </div>
        </div>
